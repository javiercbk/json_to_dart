class Sample {
	...
	Sample({this.username, this.favouriteInteger, this.favouriteDouble, this.url, this.htmlUrl, this.tags, this.randomIntegers, this.randomDoubles, this.personalInfo});
	...
	Sample.fromJson(Map<String, dynamic> json) {
		...
		tags = json['tags'];
		randomIntegers = json['randomIntegers'];
		randomDoubles = json['randomDoubles'];
